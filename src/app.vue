...
<script>
  ...
  export default {
    ...
    components: {
      ...
      'w-layout': Layout,
      'w-content': Content,
      'w-footer': Footer, 'w-collapse': Collapse,
